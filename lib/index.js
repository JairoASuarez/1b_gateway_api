...
const port$3 = process.env.POINTS_PORT || '4040';
const entryPoint$3 = process.env.POINTS_ENTRY || 'points/resources/point';
...
const url$4 = process.env.FAVORITES_URL || '192.168.99.101';
const port$4 = process.env.FAVORITES_PORT || '3304';
const entryPoint$4 = process.env.FAVORITES_ENTRY || 'user';
...
const url$5 = "0.0.0.0";
const port$5 = "3000";
const entryPoint$5 = "disposal_points";
